		...
		public void decodeinstruction()
		{
			...
			switch (Instructions[Offset].Instruction)
			{
				...
				case Instruction.PushString:
					...
					break;
				case Instruction.PushArrayP:

					Stack.Push("StringArray(unknown_PushArrayP)", Stack.DataType.StringPtr);

					break;
				case Instruction.PushStringNull:
					Stack.Push("\"\"", Stack.DataType.StringPtr);
					break;
				...
				case Instruction.ret0r0:
					break;
				case Instruction.ret0r1:
					break;
				case Instruction.ret0r2:
					break;
				case Instruction.ret0r3:
					break;
				case Instruction.ret1r0:
					break;
				case Instruction.ret1r1:
					break;
				case Instruction.ret1r2:
					break;
				case Instruction.ret1r3:
					break;
				case Instruction.ret2r0:
					break;
				case Instruction.ret2r1:
					break;
				case Instruction.ret2r2:
					break;
				case Instruction.ret2r3:
					break;
				case Instruction.ret3r0:
					break;
				case Instruction.ret3r1:
					break;
				case Instruction.ret3r2:
					break;
				case Instruction.ret3r3:
					break;
			...
			for (int i = 0; i < Instructions.Count; i++)
			{
				...
				switch (ins.Instruction)
				{
					...
					case Instruction.PushString:
						...
						break;
					case Instruction.PushArrayP:
						Stack.PushString("PushArrayP"); // very bad
						break;
					case Instruction.PushStringNull:
						Stack.PushString("");
						break;
